...
import { ArrowUpRight, Rocket, Globe, Users } from "lucide-react";
            ...
            <Card className="hover-card">
              ...
              <CardContent className="pb-2">
                <p>
                  ...
                  transparency and traceability for global enterprises, reducing fraud by 37% and improving 
            ...
            <Card className="hover-card">
              ...
              <CardContent className="pb-2">
                <p>
                  ...
                  by 28% and maintenance costs by 42% through smart monitoring and predictive maintenance 
                  algorithms.
                </p>
              </CardContent>
              <CardFooter className="flex justify-between items-center pt-2">
