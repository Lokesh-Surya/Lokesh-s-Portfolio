...
const VALID_TABS = ["patent", "research", "projects"];
...
const Innovation = () => {
  ...
  useEffect(() => {
    const updateTabFromHash = () => {
      ...
      if (hash.startsWith("#innovation/")) {
        const tabFromHash = hash.replace("#innovation/", "");
  ...
  const handleTabChange = (tab: string) => {
    setActiveTab(tab);
    window.history.replaceState(null, "", `#innovation/${tab}`);
  };
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Badge variant="secondary" className="text-lg">
                    Design No: 343102-001
                  </Badge>
                </div>

                <p className="text-gray-600 mb-8">
                  Design patent for an innovative vertical axis wind turbine featuring
                  leading-edge protuberances to enhance aerodynamic performance and
                ...
                <div className="flex justify-between items-center">
                  <p className="text-sm text-gray-500">
                    This patented design is currently undergoing further research for
                    potential implementation in commercial applications.
                  </p>
                  <a
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="md:flex">
                  ...
                  <div className="p-8 md:w-2/3">
                    ...
                    <h3 className="block mt-1 text-lg font-medium">
                      Effect of solidity on the dynamic behaviour of the Darrieus
                      turbine with leading-edge protuberance
                    </h3>
                    <p className="mt-2 text-gray-600">
                      This research explores the dynamic behavior of straight-type
                      Darrieus turbines with leading-edge protuberance under varying
                      solidity and tip speed ratios, identifying optimal blade
                      configurations to mitigate vortex-induced and buffeting
                      vibrations.
                    </p>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="md:flex">
                  ...
                  <div className="p-8 md:w-2/3">
                    ...
                    <h3 className="block mt-1 text-lg font-medium">
                      Aerodynamic characteristics of grooved rotating circular cylinder
                    </h3>
                    <p className="mt-2 text-gray-600">
                      This research explores the aerodynamic effects of grooves on a
                      rotating circular cylinder in uniform flow, revealing significant
                      drag reduction and lift enhancement across varying groove and spin
                      ratios through numerical simulations.
                    </p>
                    <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div id="projects" className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="hover-card">
                ...
                <CardContent className="pb-2">
                  <p>
                    Built a smart project management tool that automates planning, status
                    updates, and risk forecasting using natural language inputs and AI
                    predictions.
                  </p>
                </CardContent>
              ...
              <Card className="hover-card">
                ...
                <CardContent className="pb-2">
                  <p>
                    An industrial-grade dashboard that connects with PM tools and field
                    sensors to assess execution health in real-time.
                  </p>
                </CardContent>
                <CardFooter className="flex justify-between items-center pt-2">
                  <div className="flex gap-2">
              ...
              <Card className="hover-card">
                ...
                <CardContent className="pb-2">
                  <p>
                    Built a system that predicts optimal team allocation across multiple
                    parallel projects using machine learning on historical velocity, task
